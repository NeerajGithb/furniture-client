...
const STATUS_CONFIG: Record<OrderStatus, {
  ...
  pending: {
    ...
    message: "We've received your order and our team is verifying the details. You'll receive a confirmation email shortly with your order summary and tracking information.",
  ...
  confirmed: {
    ...
    message: "Great news! Your order has been confirmed and added to our fulfillment queue. Our team will now begin preparing your items for shipment.",
  ...
  processing: {
    ...
    message: "Our fulfillment team is currently picking, packing, and quality-checking your order. We ensure each item is properly secured for safe delivery.",
  ...
  shipped: {
    ...
    message: "Excellent! Your order has been dispatched and is currently being delivered to your address. You can track your package in real-time using the tracking information provided.",
  ...
  delivered: {
    ...
    message: "Wonderful! Your order has been successfully delivered to your address. We hope you're completely satisfied with your purchase and our service.",
  ...
  cancelled: {
    ...
    message: "Your order has been cancelled as requested. If you paid online, your refund will be processed automatically. For Cash on Delivery orders, no payment was collected.",
  ...
  returned: {
    ...
    message: "We've received your returned item(s) and processed your return request. The refund will be initiated once our quality team completes the inspection.",
...
const Card = ({ title, icon, children, className = "" }: { 
  ...
  <div className={`bg-white border border-gray-200 rounded-xs shadow-sm overflow-hidden ${className}`}>
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md mx-auto">
          <Card title="Order Not Found" icon={<AlertCircle size={18} className="text-red-500" />}
                className="border-red-200">
            <div className="text-center py-4">
              <AlertCircle className="w-16 h-16 text-red-400 mx-auto mb-4" />
              <p className="text-gray-700 font-medium mb-2">We couldn't find this order</p>
              <p className="text-gray-600 text-sm mb-4">
                {error || "The order number you're looking for doesn't exist or may have been entered incorrectly."}
              </p>
              <button
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className={`${config.headerColor} rounded-xs p-6 text-center text-white shadow-xl relative overflow-hidden`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {status !== 'delivered' && status !== 'cancelled' ? (
              <Card title="Order Progress Tracking" icon={<Truck size={18} className="text-blue-600" />}>
                <div className="space-y-4">
                  {STATUS_ORDER.filter((_, idx) => idx <= Math.max(currentStatusIndex + 1, 4)).map((statusItem, idx) => {
                    ...
                    return (
                      <div key={statusItem} className={`flex items-center gap-4 p-3 rounded-xs transition-all duration-200 ${
                        active ? 'bg-blue-50 border-2 border-blue-200 shadow-sm' : 
                        done ? 'bg-green-50 border border-green-200' : 'bg-gray-50 border border-gray-200'
                      }`}>
                        <div className={`w-8 h-8 flex items-center justify-center rounded-full flex-shrink-0 ${
                          ...
                          {done ? <CheckCircle size={16} /> : active ? <Clock size={16} /> : <Package size={16} />}
                        </div>
              ...
              <Card title="Order Successfully Completed" icon={<CheckCircle size={18} className="text-green-600" />}
                    className="border-green-200">
                <div className="text-center py-6">
                  <Gift className="w-16 h-16 text-green-500 mx-auto mb-4" />
                  <p className="text-gray-800 font-semibold text-lg mb-2">Your Order Has Been Delivered!</p>
                  <p className="text-gray-600 leading-relaxed">
                    We're thrilled that your order has reached you safely. Thank you for choosing us for your shopping needs. 
                    We hope you absolutely love your purchase!
                  </p>
                  <div className="mt-4 p-4 bg-green-50 rounded-xs">
                    <p className="text-green-700 text-sm font-medium">
                      Your satisfaction is our priority. If you have any questions or concerns, our customer support team is here to help.
                    </p>
                  </div>
                </div>
              </Card>
            ) : (
              <Card title="Order Cancellation Details" icon={<XCircle size={18} className="text-red-500" />}
                    className="border-red-200">
                <div className="text-center py-6">
                  <XCircle className="w-16 h-16 text-red-400 mx-auto mb-4" />
                  <p className="text-gray-800 font-semibold text-lg mb-2">This Order Has Been Cancelled</p>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-xs p-4">
                    <p className="text-yellow-800 text-sm">
                      Need help with something? Our customer support team is available 24/7 to assist you with any questions or to help you place a new order.
                    </p>
                  </div>
                </div>
              </Card>
          ...
          <div className="lg:col-span-1 space-y-6">
            {/* Payment Details */}
            <Card title="Payment Information" icon={order.paymentMethod === 'cod' ? <Banknote size={18} className="text-green-600" /> : <CreditCard size={18} className="text-blue-600" />}>
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-xs">See all items, pricing, and order history</p>
                  </div>
                </button>
                <button
                ...
                {status === 'delivered' && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 text-xs">Easy returns within 30 days of delivery</p>
                    </div>
                  </button>
                )}
              </div>
