...
export default function AuthModal({ isOpen, onClose }) {
  ...
  const renderOTPInput = () => (
    <motion.div className='space-y-3' variants={stepVariants} initial='enter' animate='center' exit='exit'>
                ...
                >
                  ...
                  {showForgotPassword ? (
                    <div className='space-y-4 flex-1 flex flex-col justify-center min-h-[350px]'>
                      ...
                      <form
                        onSubmit={
                          step === 1 ? handleForgotPassword : step === 2 ? handleVerifyCode : handleResetPassword
                        }
                        className='space-y-3'
                      >
                    ...
                    >
                        ...
                        {emailPassError && (
                          ...
                          >
                            ...
                            {(isOAuth ||
                              ...
                              emailPassError.toLowerCase().includes("user found with this email")) && (
                              <div className='bg-white rounded border border-red-100 p-2 space-y-1'>
                                {isOAuth && (
                                  <div className='space-y-1'>
                                    <p className='text-xs text-gray-600'>This email is linked to a Google account.</p>
                                    <motion.button
                      ...
                      >
                        ...
                        <div className='relative bg-white px-3 text-xs text-gray-500'>or continue with</div>
                      </motion.div>
          ...
          >
            ...
            <div className='absolute inset-0 flex items-center justify-center max-h-[90vh]'>
              <motion.div
                ...
                transition={{ duration: 0.4, ease: smoothEasing }}
              >
                <Image src='/offer.jpeg' alt='Authentication visual' fill className='object-cover' priority />
