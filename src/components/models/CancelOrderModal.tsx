          ...
          <div className="overflow-y-auto max-h-[calc(90vh-80px)]">
                    ...
                    {cancelReasons.map((reason) => (
                      ...
                      >
                        <div className="relative">
                          ...
                          >
                            {selectedReason === reason.id && <Check className="w-2.5 h-2.5 text-white" />}
                          </div>
                        </div>
            ...
            {step === "confirm" && (
              <div className="p-5 space-y-5">
                <div className="text-center space-y-3">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">Confirm Cancellation</h3>
            ...
            {step === "success" && (
              <div className="p-8 text-center space-y-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Order Cancelled Successfully</h3>
                  <p className="text-sm text-gray-600">
