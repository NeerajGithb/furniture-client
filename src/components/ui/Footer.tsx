                        ...
                        <div className="hidden lg:block lg:col-span-2">
                            <div className="grid grid-cols-3 gap-8">
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        {['Contact Us', 'Track Order', 'Returns', 'Shipping', 'Warranty', 'Size Guide', 'FAQs'].map((item) => (
                                            <li key={item}>
                                                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">
                                                    {item}
                                                </a>
                        ...
                        <div className="lg:hidden space-y-4">
                            <div className="border-b border-gray-100 pb-4">
                                ...
                                >
                                    ...
                                    <svg className={`w-5 h-5 text-gray-400 transition-transform ${accordionState.shop ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <div className={`overflow-hidden transition-all duration-300 ${accordionState.shop ? 'max-h-64 pb-4' : 'max-h-0'}`}>
                            ...
                            <div className="border-b border-gray-100 pb-4">
                                ...
                                >
                                    ...
                                    <svg className={`w-5 h-5 text-gray-400 transition-transform ${accordionState.categories ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <div className={`overflow-hidden transition-all duration-300 ${accordionState.categories ? 'max-h-64 pb-4' : 'max-h-0'}`}>
                                    <ul className="space-y-3 pl-4">
                                        {loading ? (
                                            [...Array(5)].map((_, i) => (
                                                <li key={i}>
                            ...
                            <div className="border-b border-gray-100 pb-4">
                                ...
                                >
                                    ...
                                    <svg className={`w-5 h-5 text-gray-400 transition-transform ${accordionState.customerCare ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <div className={`overflow-hidden transition-all duration-300 ${accordionState.customerCare ? 'max-h-64 pb-4' : 'max-h-0'}`}>
                                    <ul className="space-y-3 pl-4">
                                        {['Contact Us', 'Track Order', 'Returns', 'Shipping', 'Warranty', 'Size Guide', 'FAQs'].map((item) => (
                                            <li key={item}>
                                                <a href="#" className="text-gray-600 hover:text-gray-900 transition-colors text-sm">
